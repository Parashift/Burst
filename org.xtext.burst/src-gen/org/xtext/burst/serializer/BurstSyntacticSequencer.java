...
public class BurstSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_RuleIntersect_ENDLINETerminalRuleCall_7_a;
	protected AbstractElementAlias match_RuleIntersect_ENDLINETerminalRuleCall_8_1_p;
	...
	protected void init(IGrammarAccess access) {
		...
		match_RuleIntersect_ENDLINETerminalRuleCall_7_a = new TokenAlias(true, true, grammarAccess.getRuleIntersectAccess().getENDLINETerminalRuleCall_7());
		match_RuleIntersect_ENDLINETerminalRuleCall_8_1_p = new TokenAlias(true, false, grammarAccess.getRuleIntersectAccess().getENDLINETerminalRuleCall_8_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_Concern_ENDLINETerminalRuleCall_3_0_a.equals(syntax))
			...
			else if (match_RuleIntersect_ENDLINETerminalRuleCall_7_a.equals(syntax))
				emit_RuleIntersect_ENDLINETerminalRuleCall_7_a(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_RuleIntersect_ENDLINETerminalRuleCall_8_1_p.equals(syntax))
				emit_RuleIntersect_ENDLINETerminalRuleCall_8_1_p(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     params+=WithParameter ENDLINE* (ambiguity) ENDLINE* params+=WithParameter
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     params+=Parameter 'with' (ambiguity) params+=WithParameter
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     params+=WithParameter (ambiguity) (',' | 'and') ENDLINE* params+=WithParameter
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     params+=WithParameter ENDLINE* (',' | 'and') (ambiguity) params+=WithParameter
	 */
	 ...
	 *     params+=Parameter '{' (ambiguity) lines+=Line
	 *     params+=WithParameter '{' (ambiguity) '}' (rule end)
	 *     params+=WithParameter '{' (ambiguity) lines+=Line
	 */
	protected void emit_RuleIntersect_ENDLINETerminalRuleCall_7_a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 */
	protected void emit_RuleIntersect_ENDLINETerminalRuleCall_8_1_p(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
