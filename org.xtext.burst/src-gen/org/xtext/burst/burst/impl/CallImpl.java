...
public class CallImpl extends MinimalEObjectImpl.Container implements Call
{
  ...
  public NotificationChain basicSetName(EObject newName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BurstPackage.CALL__NAME, oldName, newName);
  ...
  public void setName(EObject newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BurstPackage.CALL__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BurstPackage.CALL__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BurstPackage.CALL__NAME, newName, newName));
  }
