...
public class FileImpl extends MinimalEObjectImpl.Container implements File
{
   ...
   * @ordered
   */
  protected EList<FileElement> elements;
   ...
   * @generated
   */
  public EList<FileElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<FileElement>(FileElement.class, this, BurstPackage.FILE__ELEMENTS);
    }
    return elements;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case BurstPackage.FILE__ELEMENTS:
        getElements().clear();
        getElements().addAll((Collection<? extends FileElement>)newValue);
        return;
    }
