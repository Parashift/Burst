 ...
 * </p>
 * <ul>
 *   <li>{@link burst.impl.FileImpl#getConcern <em>Concern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FileImpl extends MinimalEObjectImpl.Container implements File {
	...
	public EList<concern> getConcern() {
		if (concern == null) {
			concern = new EObjectContainmentEList<concern>(concern.class, this, BurstPackage.FILE__CONCERN);
		}
		return concern;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BurstPackage.FILE__CONCERN:
