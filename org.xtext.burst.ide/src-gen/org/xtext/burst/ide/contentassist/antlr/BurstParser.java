		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCallMemberInConcernAccess().getGroup(), "rule__CallMemberInConcern__Group__0");
					...
					put(grammarAccess.getCallMemberInConcernAccess().getTargetAssignment_1(), "rule__CallMemberInConcern__TargetAssignment_1");
					put(grammarAccess.getCallMemberInConcernAccess().getNameAssignment_3(), "rule__CallMemberInConcern__NameAssignment_3");
				}
			};
		}
