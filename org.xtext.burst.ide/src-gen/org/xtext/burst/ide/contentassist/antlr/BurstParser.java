		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCallAccess().getContentAssignment_0(), "rule__Call__ContentAssignment_0");
					put(grammarAccess.getCallAccess().getEqualityAssignment_1_0(), "rule__Call__EqualityAssignment_1_0");
					put(grammarAccess.getCallAccess().getSourceAssignment_1_1(), "rule__Call__SourceAssignment_1_1");
